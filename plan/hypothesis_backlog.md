...
<!-- hypothesis_new.py appended --> H054 | Anti-gate first-hour ORB on CME ES/NQ futures (HMM-gated stress-state subset on fresh OOS) | empirical motivation H052a KPI v1; [Hamilton 1989](https://doi.org/10.2307/1912559); [Bollerslev-Tauchen-Zhou 2009](https://doi.org/10.1093/rfs/hhp008); [Cochrane 2011](https://doi.org/10.1111/j.1540-6261.2011.01671.x); [Hurst-Ooi-Pedersen 2017](https://www.pm-research.com/content/iijpormgmt/44/1/15); [Guidolin-Timmermann 2007](https://doi.org/10.1016/j.jedc.2006.12.004); design [research/01_hypothesis_register/H054/design.md](../research/01_hypothesis_register/H054/design.md) | kpi-report-emitted |
<!-- hypothesis_new.py appended --> H055 | Mechanized intraday wick-rejection scalping with deterministic trend gate (HMM-deferred to v3) on CME ES/NQ/MES/MNQ | [Lehmann 1990 QJE](https://doi.org/10.2307/2937816); [Lo-MacKinlay 1990 RFS](https://doi.org/10.1093/rfs/3.2.175); [Moskowitz-Ooi-Pedersen 2012 JFE](https://doi.org/10.1016/j.jfineco.2011.11.003); [Andersen-Bollerslev-Diebold-Labys 2003 ECTA](https://doi.org/10.1111/1468-0262.00418); [Bouchaud-Gefen-Potters-Wyart 2004 QF](https://doi.org/10.1080/14697680400000022); [Lucca-Moench 2015 JoF](https://doi.org/10.1111/jofi.12196); design [research/01_hypothesis_register/H055/design.md](../research/01_hypothesis_register/H055/design.md); pilot ledger [data/external/h055_pilot_ledger/Performance.csv](../data/external/h055_pilot_ledger/Performance.csv); audit trail [docs/audits/audit_trail_2026-05-06_h055_wick_reversal_design.md](../docs/audits/audit_trail_2026-05-06_h055_wick_reversal_design.md) | designed |
<!-- hypothesis_new.py appended --> H056 | Per-component ML successor of H055 — Layer 1 of the per-component → stacking → multi-TF architecture per ADR-0015 (lifts SKIE-NINJA-Volatility under ADR-0016 audit-and-lift; new ML models for body-overlap, level-exhaustion, swing-pivot probability) | [Wolpert 1992 NN](https://doi.org/10.1016/S0893-6080(05)80023-1); [Breiman 1996 ML](https://doi.org/10.1007/BF00117832); [van der Laan-Polley-Hubbard 2007 SAGMB](https://doi.org/10.2202/1544-6115.1309); [Niculescu-Mizil-Caruana 2005 ICML](https://doi.org/10.1145/1102351.1102430); [Bailey-López de Prado 2014 JPM](https://doi.org/10.3905/jpm.2014.40.5.094); roadmap [plan/h055_successor_tree_2026-05-06.md](h055_successor_tree_2026-05-06.md); architecture [docs/decisions/ADR-0015-component-stacking-master-architecture.md](../docs/decisions/ADR-0015-component-stacking-master-architecture.md); lift protocol [docs/decisions/ADR-0016-sibling-repo-audit-and-lift-protocol.md](../docs/decisions/ADR-0016-sibling-repo-audit-and-lift-protocol.md) | queued |
<!-- hypothesis_new.py appended --> H057 | Stacking master successor of H056 — Layer 2 (Super Learner / MoE / BMA / FWLS over the H056 component panel; per-successor design.md picks the master architecture) | [van der Laan-Polley-Hubbard 2007 SAGMB](https://doi.org/10.2202/1544-6115.1309); [Jacobs-Jordan-Nowlan-Hinton 1991 Neural Comp](https://doi.org/10.1162/neco.1991.3.1.79); [Hoeting-Madigan-Raftery-Volinsky 1999 Stat Sci](https://www.jstor.org/stable/2676803); [Sill-Takács-Mackey-Lin 2009 arXiv](https://arxiv.org/abs/0911.0460); roadmap [plan/h055_successor_tree_2026-05-06.md](h055_successor_tree_2026-05-06.md); architecture [docs/decisions/ADR-0015-component-stacking-master-architecture.md](../docs/decisions/ADR-0015-component-stacking-master-architecture.md) | queued |
<!-- hypothesis_new.py appended --> H058 | Multi-TF attention orchestrator of H057 — Layer 3 (TF-attention master per Vaswani et al. 2017 lifted to tabular setting; one stacking master per timeframe with attention integration) | [Vaswani et al. 2017 NeurIPS / arXiv](https://arxiv.org/abs/1706.03762); [Andersen-Bollerslev-Diebold-Labys 2003 ECTA](https://doi.org/10.1111/1468-0262.00418); roadmap [plan/h055_successor_tree_2026-05-06.md](h055_successor_tree_2026-05-06.md); architecture [docs/decisions/ADR-0015-component-stacking-master-architecture.md](../docs/decisions/ADR-0015-component-stacking-master-architecture.md) | queued |
<!-- hypothesis_new.py appended --> H059 | Live probability display layer (calibrated direction probability + first-passage-time price targets via Karatzas-Shreve 1991 + bootstrap-conditional; presentation-only — not a new H_0 / H_1) | Karatzas & Shreve 1991 *Brownian Motion and Stochastic Calculus* Springer ISBN 978-0387976556 *textbook*; [Niculescu-Mizil-Caruana 2005 ICML](https://doi.org/10.1145/1102351.1102430); [Gneiting-Katzfuss 2014 Annual Rev Stat](https://doi.org/10.1146/annurev-statistics-062713-085831); roadmap [plan/h055_successor_tree_2026-05-06.md](h055_successor_tree_2026-05-06.md) | queued |

## 2026-05-08 — ADR-0017 inheritance cascade

[ADR-0017 survival-constrained optimization paradigm](../docs/decisions/ADR-0017-survival-constrained-optimization-paradigm.md) (2026-05-08) inherits at design-time for every hypothesis from H055 forward (H055, H056, H057, H058, H059, plus all parallel-track variants in [plan/h055_successor_tree_2026-05-06.md](h055_successor_tree_2026-05-06.md)). Each design.md §1 statement under ADR-0017 inheritance is written under the survival-constrained paradigm from inception (no Sharpe-differential T_H statistic in §1; Sharpe-family computation reported as KPI annotation per ADR-0017 §1.2). The 8 hard kill-switch constraints K-1..K-8 (per ADR-0017 §5) and the drawdown-constrained Kelly sizing primitive (per ADR-0017 §4.1) are mandatory inheritance for every hypothesis from H055 forward.
