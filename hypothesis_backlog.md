...
| **H062** | Intraday Donchian-channel breakout on {ES, NQ, MGC, SIL} at super-Kelly grid with BOCD halt + switching-bandit redirect | 2c | `kpi-report-emitted` (v1) | Non-significant null on basket MPPM(ρ=1) CI=[-0.599, +0.172]; realized +43% basket ROI but 91% MaxDD; τ_3=+0.74 confirms skew-positive design prediction; quarter-Kelly unanimous 93/93 folds. |
