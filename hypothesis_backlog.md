...
| **H055** | Mechanized wick-rejection scalping (HMM-deferred v3) | 2b | `exploration-in-progress` (`designed` frozen) | Pre-launch; 7+ BLOCKING preconditions outstanding (level-state fold-continuity test, PIT canary integration, news calendar ingest, power simulation, calibration holdout run, ADR-0017 survival primitives wiring). |
...
| H061 | Cross-futures TSMOM with full-size NYMEX WTI (CL) added to the H060 v1 basket → 5-asset {ES, NQ, CL, MGC, SIL}; v2-with-CL successor to H060 v1 | Same TSMOM canon as H060 + [Hamilton 1996 *JME* 38(2):215-220 DOI 10.1016/S0304-3932(96)01282-2](https://doi.org/10.1016/S0304-3932(96)01282-2) oil-macro mechanism anchor; design [H061/design.md](research/01_hypothesis_register/H061/design.md); substrate-extension blocked on `P1-H061-CL-SUBSTRATE-EXTRACTION-AUTHORIZE` (~$240 USD Databento extraction per 2026-05-12 cost-dossier) | designed (queued at production-run pending CL substrate extraction) |
