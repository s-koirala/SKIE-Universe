...
### H053 - Sovereign CDS and cross-border risk-on signal (LOW-MED)
- `[P]` Longstaff, Pan, Pedersen, Singleton, *How sovereign is sovereign credit risk?*, American Economic Journal: Macroeconomics 3, 2011, [10.1257/mac.3.2.75](https://doi.org/10.1257/mac.3.2.75) `[UNVERIFIED — not re-fetched]`.
- `[P]` Augustin, Subrahmanyam, Tang, Wang, *Sovereign credit risk and exchange rates: Evidence from CDS quanto spreads*, Journal of Financial Economics 137, 2020, [10.1016/j.jfineco.2020.01.001](https://doi.org/10.1016/j.jfineco.2020.01.001) `[UNVERIFIED — not re-fetched]`.
