...
- **Calibration: Brier Skill Score (BSS) bootstrap-CI lower-bound > 0** vs per-instrument climatological prior on the OOS fold (`applicable: yes` — H053 ships the §4.5 K×3 categorical-archetype-bias-target probability table). **AMENDED 2026-05-03 per [ADR-0013](../../../docs/decisions/ADR-0013-walk-forward-grid-and-calibration-CI.md) §B**: was point-test "BSS > 0"; now paired stationary bootstrap on (p_oof, d) tuples, B=2000, [Politis & Romano 1994 *JASA* 89(428):1303-1313 doi:10.2307/2290993](https://doi.org/10.2307/2290993), [PW 2004](https://doi.org/10.1081/ETC-120028836)+[PPW 2009](https://doi.org/10.1080/07474930802459016) block length, 95% percentile. Procedurally MORE conservative than the point test (within ADR-0012 §"Frozen pre-registration amendment" §10 carve-out); preserves the design.md §4.5.3 estimator family (no §1-§7 change).
- **Calibration: reliability slope CI covers 1.0** per [Bröcker & Smith 2007 *Weather and Forecasting* 22(3):651-661 doi:10.1175/WAF993.1](https://doi.org/10.1175/WAF993.1) (`applicable: yes` for the §4.5 categorical table). **AMENDED 2026-05-03 per ADR-0013 §B**: was fixed-band "slope ∈ [0.7, 1.3]"; now paired stationary bootstrap on (p_oof, d) tuples, B=2000, same procedure as binary BSS gate; binding test = `1.0 ∈ [slope_lower_CI, slope_upper_CI]`. Parameter-free + citation-anchored.
