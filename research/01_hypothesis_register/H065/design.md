...
- **Secondary inferential KPIs** (per ADR-0017 §1.2 demotion machinery): per-symbol Sharpe-differential under [Ledoit-Wolf 2008 *JEF* 15(5):850-859](https://doi.org/10.1016/j.jempfin.2008.03.002) studentized stationary-bootstrap CI; Hansen 2005 SPA p reported as KPI annotation per [ADR-0008](../../../docs/decisions/ADR-0008-spa-omega-method.md) at M=4-cells (basket-level family) + M=16 (per-symbol family).
...
- **2026-05-18 — Hsu-Kuan 2005 erratum addendum (inherited from H062 Path A amendment).** Post-merge audit-remediate-loop Round 1 literature-check (`docs/audits/audit_trail_2026-05-18_phase-o-merge-audit.md`) surfaced H062-inherited Hsu-Kuan 2005 finding inversion in §1.4 partial-decay framing. Canonical correction at [`research/01_hypothesis_register/_erratum_hsu_kuan_2005_2026-05-18.md`](../_erratum_hsu_kuan_2005_2026-05-18.md). Original §1.4 preserved verbatim per ADR-0013 immutability discipline. NQ-specific interpretive framing flips (SURVIVES-SPA young-market regime, NOT "harder-to-beat"); ES + MGC + SIL framing unchanged. H_1 + numerical claims unchanged.
