...
**2026-05-06 amendment** (Path A): §14.1 cross-TF robustness exhibits (informational; not gating) and §12.2 successor cross-links (H056 → H057 → H058 → H059 main chain + H055-CL/MCL/MYM/MGC v2 + H055-event-time parallel tracks) added per ADR-0015 + ADR-0016 + [plan/h055_successor_tree_2026-05-06.md](../../../plan/h055_successor_tree_2026-05-06.md). §1-§7 immutable and preserved verbatim. Decision-log entry at §17.
