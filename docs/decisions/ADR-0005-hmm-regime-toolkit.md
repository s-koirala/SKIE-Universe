...
- Initialization: k-means++ on emission features. Random-restart count is not fixed: restart until the top-two fitted log-likelihoods agree within ε, with ε = 2 × SE of EM log-likelihood on a bootstrap re-fit of the training fold. Minimum of 5 restarts to bound worst-case EM-pathology probability under the weakest unimodality assumption; floor justified by [Biernacki, Celeux, Govaert 2003, Comp. Stat. Data Anal. 41(3–4):561–575](https://doi.org/10.1016/S0167-9473(02)00163-9).
